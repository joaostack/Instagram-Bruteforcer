...
if args.wordlist and args.username:
    ...
    print(f"{ascii_art}\n{verde_limao_ansi}ATTACKING {
          username} FROM WORDLIST {wordlist}...{resetar_cores}")
    ...
    def login(linha_wordlist, numero_linha_wordlist):
        ...
        if "\"authenticated\":false" or "\"status\":\"fail\"" in req.text:
            print(
                Fore.RED + f"\r{numero_linha_wordlist} PASSWORDS TESTED...", end="" + Fore.RESET)
        else:
            print(
